...
<body>
        ...
        @foreach($events as $event)
            <div class="event-box">
                ...
                <div class="action-buttons">
                    ...
                    <!-- Delete Button -->
                    <button class="delete-btn" onclick="openModal({{ $event->id }})" data-id="{{ $event->id }}">Delete</button>
                </div>
            </div>
        @endforeach
    </div>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form id="deleteForm" action="{{ route('event.destroy', ['event' => $event]) }}" method="POST" >
                @csrf
                @method('DELETE')
